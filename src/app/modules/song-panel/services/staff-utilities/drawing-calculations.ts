...
export class DrawingCalculations {
    ...
    public static getEventsToDraw(song: Song, simplificationNo: number, voice: number): SoundEvent[] {
        ...
        for (let i = 0; i < voiceNotes.length; i++) {
            ...
            let endOfCurrentBar = currentBar < bars.length ? bars[currentBar].ticksFromBeginningOfSong : song.midiStats.durationInTicks
            ...
            while (currentBar < noteBar) {
                ...
                currentBar++
                endOfCurrentBar = currentBar < bars.length ? bars[currentBar].ticksFromBeginningOfSong : song.midiStats.durationInTicks
            }
